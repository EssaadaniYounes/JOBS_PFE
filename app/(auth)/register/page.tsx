...
function page() {
  ...
  <div
     className="min-w-screen h-screen flex items-center justify-center px-5 py-5">
    <div
       className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-5xl">
      <div  className="md:flex w-full">
          ...
          <div >
            ...
            <div className="flex  m-2">
                  ...
                  <div className="flex items-center justify-between space-x-6 ml-2">
                    <div>
                      <input
                        onChange={handleChange}
                        value="JobSeeker"
